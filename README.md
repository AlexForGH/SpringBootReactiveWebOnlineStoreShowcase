...
## *EN*
#### Link to the previous project based on the Spring Boot and blocking technology stack: https://github.com/AlexForGH/SpringBootWebOnlineStoreShowcase.git
The project demonstrates development capabilities using Spring Boot: Spring WebFlux, Spring Data R2DBC
on a reactive technology stack.
Technology stack: Spring Framework, Spring Boot, H2DB, HTML, Thymeleaf, Spring WebFlux, Spring Data R2DBC.
...
## *RU*
#### Ссылка на следующий проект на основе Spring Boot и блокирующего стека технологий: https://github.com/AlexForGH/SpringBootWebOnlineStoreShowcase.git
Проект для демонстрации возможностей разработки с использованием Spring Boot: Spring WebFlux, Spring Data R2DBC
на реактивном стеке технологий.
Технологический стек: Spring Framework, Spring Boot, H2DB, HTML, Thymeleaf, Spring WebFlux, Spring Data R2DBC.
